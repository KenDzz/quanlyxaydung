            ...
            <ul class="accordion-menu">
                ...
                <li class="open active">
                    ...
                    <ul class="sub-menu" style="display: block;">
                        <!-- Active Page -->
                        <li class="active"><a href="analytic-index.html">Dashboard</a></li>
                        <li><a href="analytic-audience.html">Audience</a></li>
                        <li><a href="analytic-acquisition.html">Acquisition</a></li>
                        <li><a href="analytic-realtime.html">Realtime</a></li>
                    </ul>
                </li>
                <li>
                    <a href="">
                        ...
                        <svg class="adata-svg-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <path
                                    ...
                                    id="Oval" fill="#000000" fill-rule="nonzero" opacity="0.3">
                                </path>
                                ...
                                <path
                                    ...
                                    id="Oval-70" fill="#000000" fill-rule="nonzero"></path>
                            </g>
                        </svg>
                        <span>Maps</span><i class="accordion-icon fa fa-angle-left"></i>
                    </a>
                    <ul class="sub-menu">
                        <li><a href="../map/map-google.html">Google Maps</a></li>
                        <li><a href="../map/map-vector.html">Vector Maps</a></li>
                    </ul>
                </li>
                <li class="menu-label">Advanced Extension</li>
                <li>
                    <a href="">
                        <svg class="adata-svg-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="../pages/pages-starter.html">Starter Page</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="../email-templates/account/new-account/new-account.html" target="_blank">New
                                Account</a></li>
                        ...
                        <li><a href="../email-templates/account/expired-card/expired-card.html"
                                target="_blank">Expired Card</a></li>
                        ...
                        <li><a href="../email-templates/launch/user-welcome/user-welcome.html" target="_blank">User
                                Welcome</a></li>
                        <li><a href="../email-templates/launch/coming-soon/coming-soon.html" target="_blank">Coming
                                Soon</a></li>
                        ...
                        <li><a href="../email-templates/marketing/blog-post/blog-post.html" target="_blank">Blog
                                Post</a></li>
                        <li><a href="../email-templates/marketing/coupon-sale/coupon-sale.html" target="_blank">Coupon
                                Sale</a></li>
                ...
                <li>
                    <a href="../../../documentation/documentation.html" target="_blank">
                        <svg class="adata-svg-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <polygon points="0 0 24 0 24 24 0 24" />
                                <path
                ...
                <li>
                    <a href="../../../documentation/changelog.html" target="_blank">
                        <svg class="adata-svg-icon">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24" />
                                <path
