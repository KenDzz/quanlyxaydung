                            ...
                            <div class="notifications-box" id="notificationsBox">
                                ...
                                <a class="dropdown-item list-group-item" href="">
                                    ...
                                    <div class="overflow-hidden">
                                        ...
                                        <div class="tx-12 d-block text-truncate">System reboot has been successfully
                                            completed</div>
                                ...
                                <a class="dropdown-item list-group-item" href="">
                                    ...
                                    <div class="overflow-hidden">
                                        ...
                                        <div class="tx-12 d-block text-truncate">New user feedback received</div>
                                        <span class="tx-11 tx-gray-400">Mar 15, 12:32pm</span>
                                    </div>
                                </a>
                                <a class="dropdown-item list-group-item" href="">
                                    ...
                                    <div class="overflow-hidden">
                                        ...
                                        <div class="tx-12 d-block text-truncate">New payment has been failed</div>
                                        <span class="tx-11 tx-gray-400">Mar 15, 12:32pm</span>
                                    </div>
                                </a>
                                <a class="dropdown-item list-group-item" href="">
                                    ...
                                    <div class="overflow-hidden">
                                        <h3 class="tx-15 mg-b-5">Document available</h3>
                                        <div class="tx-12 d-block text-truncate">New order has been received</div>
                                        <span class="tx-11 tx-gray-400">Mar 15, 12:32pm</span>
                                    </div>
                                </a>
                                <div class="clearfix"></div>
                                <div class="notifications-date tx-uppercase d-block ">Yesterday, Mar 19</div>
                                <a class="dropdown-item list-group-item" href="">
                                    <div class="d-flex justify-content-between">
                                        <div
                                            class="wd-40 ht-40 mg-r-10 d-flex align-items-center justify-content-center rounded card-icon-success">
                            ...
                            <div class="message-box" id="messageBox">
                                ...
                                <a class="dropdown-item list-group-item" href="javascript:void(0)">
                                    ...
                                    <div class="overflow-hidden">
                                        ...
                                        <div class="tx-12 text-truncate">Congratulate! Socrates Itumayfor work
                                            anniversaries</div>
                                    </div>
                                </a>
                                <a class="dropdown-item list-group-item" href="javascript:void(0)">
                                    ...
                                    <div class="overflow-hidden">
                                        ...
                                        <div class="tx-12 text-truncate">Richards Caleb, just created a new blog post
                                        </div>
                                    </div>
                                </a>
                                <a class="dropdown-item list-group-item" href="javascript:void(0)">
                                ...
                                <a class="dropdown-item list-group-item" href="javascript:void(0)">
                                    ...
                                    <div class="overflow-hidden">
                                        ...
                                        <div class="tx-12 text-truncate">Adrian Monino, added new comment on your photo
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a class="dropdown-item list-group-item" href="javascript:void(0)">
                                    ...
                                    <div class="overflow-hidden">
                                        ...
                                        <div class="tx-12 text-truncate">Edward Lane, added new comment on your photo
                                        </div>
                                    </div>
                                </a>
                                <a class="dropdown-item list-group-item" href="javascript:void(0)">
                                    ...
                                    <div class="overflow-hidden">
                                        ...
                                        <div class="tx-12 text-truncate">Edward Lane, just created a new blog post
                                        </div>
                                    </div>
                                </a>
                                <a class="dropdown-item list-group-item" href="javascript:void(0)">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-profile">
                        <div class="user-profile-area">
                            ...
                            <a href="{{ route('logout') }}" class="dropdown-item d-flex align-items-center">
                                <span data-feather="log-out" class="wd-16 ht-16 mr-2"></span>
                                Sign Out
                            </a>
                        </div>
                    </div>
