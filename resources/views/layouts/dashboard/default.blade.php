...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{ url('plugins/summernote/summernote.min.css') }}">
    <link type="text/css" rel="stylesheet" href="{{ url('plugins/dropzone/dropzone.css') }}">
    <link type="text/css" rel="stylesheet" href="{{ url('plugins/chart.js/chart.min.css') }}" />
    <link type="text/css" rel="stylesheet" href="{{ url('plugins/d3/cal-heatmap/cal-heatmap.css') }}" />
    <link type="text/css" rel="stylesheet" href="{{ url('plugins/jqvmap/jquery-jvectormap-2.0.2.css') }}">
    <link type="text/css" rel="stylesheet" href="{{ url('plugins/dataTable/datatables.min.css') }}">
    <link type="text/css" rel="stylesheet"
        href="{{ url('plugins/dataTable/extensions/dataTables.jqueryui.min.css') }}">
    <link type="text/css" rel="stylesheet" href="{{ url('plugins/fullcalendar/fullcalendar.css') }}" />
    <link type="text/css" rel="stylesheet" href="{{ url('plugins/fullcalendar/fullcalendar.print.css') }}"
        media="print" />
    <link type="text/css" rel="stylesheet" href="{{ url('plugins/flatpickr/flatpickr.min.css') }}" />
    <!-- END: Vendor CSS-->
    <!-- BEGIN: Custom CSS-->
...
<body>
    ...
    <script>
        ...
        $(function() {
            ...
            $('#start-date-work').daterangepicker({
                singleDatePicker: true,
                showDropdowns: true,
                drops: "up",
                minYear: 1901,
    ...
    <script src="{{ url('plugins/summernote/summernote-active.js') }}"></script>
    <script src="{{ url('plugins/dropzone/dropzone.js') }}"></script>
    <script src="{{ url('plugins/chart.js/chart.min.js') }}"></script>
    <script src="{{ url('plugins/d3/d3.min.js') }}"></script>
    <script src="{{ url('plugins/d3/cal-heatmap/cal-heatmap.min.js') }}"></script>
    ...
    <script src="{{ url('plugins/flot/sampledata.js') }}"></script>
    <script src="{{ url('plugins/jqvmap/jquery-jvectormap-2.0.2.min.js') }}"></script>
    <script src="{{ url('plugins/jqvmap/gdp-data.js') }}"></script>
    <script src="{{ url('plugins/jqvmap/maps/jquery-jvectormap-world-mill-en.js') }}"></script>
    <script src="{{ url('plugins/dataTable/datatables.min.js') }}"></script>
    <script src="{{ url('plugins/dataTable/responsive/dataTables.responsive.js') }}"></script>
    <script src="{{ url('plugins/dataTable/extensions/dataTables.jqueryui.min.js') }}"></script>
    <script src="{{ url('plugins/flatpickr/flatpickr.js') }}"></script>
    <script src="{{ url('plugins/fullcalendar/fullcalendar.js') }}"></script>
    <script src="{{ url('plugins/fullcalendar/fullcalendar-init.js') }}"></script>
    ...
    <script>
        ...
        var myDropzone = new Dropzone("#dropzone-work", {
            acceptedFiles: ".docx,.pdf,.jpg,.jpeg,.png,.gif,.dwg,.dxf",
    ...
    <script>
        // FullCalendar Active JS
        Pace.on('done', function() {
            Elk.FullCalendar();
        });

        // Scroll Active JS
        new PerfectScrollbar('.calendar-wrapper', {
